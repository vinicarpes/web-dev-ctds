...
<body>
 <h1> Funções de usuário e includes em PHP - exercício 7 da listaL1 </h1>

 <form action="exerc7.php" method="post">
  <fieldset>
   <legend> Funções de usuário e includes em PHP - conversão termométrica </legend>
 ...
 <?php
 require_once "../includes/exerc7.inc.php";

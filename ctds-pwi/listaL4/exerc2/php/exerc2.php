...
<body>
    ...
    <h1>Matrizes em PHP - Lista L4 - exerc2</h1>
    <?php
    ...
    //para calcularmos a média geral da turma:
    //criando vetor auxiliar para obter as médias
    foreach ($matrizAlunos as $mtcl => $vetorInterno) {
        $vetorAux[] = $vetorInterno[1];
    }

    $media = number_format(array_sum($vetorAux) / count($vetorAux), 2, ',', '.');
    ...
    echo "</table>";
    echo "<p>Média geral dos alunos: $media</p>"
